...
import com.example.medprep.api.api.MakeCovidRequest;
import com.example.medprep.api.api.MakeDiagnoseRequest;
import com.example.medprep.api.api.MakeParseRequest;
import com.example.medprep.api.api.RequestUtil;
import com.example.medprep.databinding.ActivityChatBinding;
...
import com.example.medprep.helpers.helpers.PdfProducer;
        ...
        if (requestCode == 300) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                if (GlobalVariables.getInstance().getCurrentChat().isPresent()) {
                    PdfProducer.createPdfFile(this,
                            ChatSQLiteDBHelper.getAllMessagesForChat(this,
